...
class GeometriesTest {
    ...
    void testFindIntersections() {//ok
        ...
        assertEquals(new ArrayList<Point>(
                        Arrays.asList
                                (new Point(0.006246096189881811,-0.4896939412866957,3.0081199250468456),
                                new Point(-0.4918032786885256,-0.5140983606557377,3.1580327868852462))),
                geometries.findIntersections
                        (new Ray
                                (new Point(10,0,0), new Vector(-10,-0.49,3.01).normalize())),
        ...
        geometries2.add(
                new Plane(new Point(0,1,0), new Point(1,0,0), new Point(0,0,1)),
        ...
        assertEquals(new ArrayList<Point>(
                ...
                geometries2.findIntersections
                        (new Ray
                                (new Point(4.68,3.72,0),
                                        new Vector(-3.21,-2.97,0.77).normalize())),
