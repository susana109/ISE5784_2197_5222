...
class PointTest {
    ...
    void testAdd() {
        ...
        // TC01:Check if the addition of the vector to the point produces the correct result
        assertEquals(new Point(2, 4, 6), p1.add(v1), "ERROR: Point + Vector does not work correctly");

        // TC02:Check if the addition of the opposite vector is equals to zero
    ...
    void testDistanceSquared() {
        ...
        // TC03:Check if the squared distance to itself is zero
        assertEquals(0, p1.distanceSquared(p1), 0.00001, "ERROR: point squared distance to itself is not zero");

        // TC04:Check if the squared distance between two points is calculated correctly
        assertEquals(9, p1.distanceSquared(p3), 0.00001, "ERROR: squared distance between points is wrong");

        // TC05:Check if the squared distance between two points is calculated correctly
    ...
    void testDistance() {
        ...
        // TC06:Check if the distance between two points is calculated correctly
        assertEquals(3, p1.distance(p3), 0.00001, "ERROR: distance between points is wrong");

        // TC07:Check if the distance between two points is calculated correctly
        assertEquals(3, p3.distance(p1), 0.00001, "ERROR: distance between points is wrong");

        // TC08:Check if the distance between two points is zero
    ...
    void testSubtract() {
        ...
        // TC09:Check if the subtraction of one point from another produces the correct vector
        assertEquals(new Vector(1, 2, 2), p3.subtract(p1), "ERROR: Point - Point does not work correctly");

        // =============== Boundary Values Tests ==================
        //TC10:Check if subtracting a point from itself throws an IllegalArgumentException
