...
/**
    ...
    public class GeometriesTest {
        ...
        void testFindIntersections() {
            ...
            assertNull("ERROR - no intersections when no geometries in collection",
                               geometries.findIntersections(new Ray(Point.ZERO, new Vector(1,0,0))));
            ...
            assertNull("ERROR - no intersections at all between the geometries " ,
                    geometries.findIntersections(new Ray(new Point(0,6,0), new Vector(-10,-6,0).normalize())));
            ...
            ArrayList<Point> arrayPoint3D =  new ArrayList<Point>(
                    Arrays.asList(new Point(0.006246096189881811,-0.4896939412866957,3.0081199250468456),new Point(-0.4918032786885256,-0.5140983606557377,3.1580327868852462)));
            ...
            assertEquals(
                    ...
                    new ArrayList<Point>(
                                        Arrays.asList
                                                (new Point(0.2892421441774484, -0.3424768946395571, 1.0532347504621073),
                                                new Point(1.4759334565619229, 0.7554898336414051, 0.7685767097966727),
                                                new Point(-1.509064748201438, -2.0063309352517984, 1.4846043165467624))), geometries2.findIntersections(new Ray(new Point(4.68,3.72,0), new Vector(-3.21,-2.97,0.77).normalize())));
        }
}
